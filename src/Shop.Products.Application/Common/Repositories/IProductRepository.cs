...
public interface IProductRepository
{
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    Task<Result<PagedList<Product>>> GetAllProductsAsync(GetPagedProductListRequest request,
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    Task<Result<Product>> UpdateProductQuantityAsync(int productId, int newQuantity,
        CancellationToken cancellationToken = default);
}